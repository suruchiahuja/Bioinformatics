...
# Problem 2
## 2.1 Boxplot
Boxplts are created for individual variables or a group of variables.
...
## 2.3 Bean Plot
Beanplot plots univariate comparision graphs, it is an alternative to boxplot/stripchart/violin plot.
```{r, message=FALSE}
require(beanplot)
...
# Problem 3
## 3.1 Heatmaps
A heatmap is a false color image with a dendogram added to the left side and to the top.
...
# Problem 4
## 4.1 Pre-processing
We removed NAs and zeroes from the Platinum Spike Data.
```{r}
